...
BEGIN
    ...
    if NASPORTID is null then
        ...
        if substr(t_hf_port,0,4) = 'xpon'  then
            ...
            --SUBSTR(SUBSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, ' ')+1 ,length(NASPORTID)),INSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, ' ')+1 ,length(NASPORTID)),' '),length(NASPORTID)),1,INSTR(SUBSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, ' ')+1 ,length(NASPORTID)),INSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, ' ')+1 ,length(NASPORTID)),' '),length(NASPORTID)), ':') - 1) into t_port_group from dual;
            select SUBSTR(NASPORTID,1,INSTR(NASPORTID, ' ')) ||
            SUBSTR(SUBSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, ' ') + 1,length(NASPORTID)),INSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, ' ') + 1,length(NASPORTID)), ' ') + 1,length(NASPORTID)),1,INSTR(SUBSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, ' ') + 1,length(NASPORTID)),INSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, ' ') + 1,length(NASPORTID)), ' ') + 1,length(NASPORTID)), ' ') - 1) into t_port_group from dual;
        ...
        select SUBSTR(NASPORTID, 1, INSTR(NASPORTID, '/') - 1) || ' ' || SUBSTR(NASPORTID, INSTR(NASPORTID, '/')+1,INSTR(substr(NASPORTID,instr(NASPORTID,'/')), '/H')-2) into t_port_group from dual;
            
        elsif substr(t_hf_port,0,3)  = 'XPT' then
        select SUBSTR(NASPORTID, 1, INSTR(NASPORTID, '/') - 1) || ' ' || SUBSTR(NASPORTID, INSTR(NASPORTID, '/')+1,INSTR(substr(NASPORTID,instr(NASPORTID,'/')), '/X')-2) into t_port_group from dual;
        
        elsif substr(t_hf_port,0,3)  = 'T3T' then
        select SUBSTR(NASPORTID, 1, INSTR(NASPORTID, '/') - 1) || ' ' || SUBSTR(NASPORTID, INSTR(NASPORTID, '/')+1,INSTR(substr(NASPORTID,instr(NASPORTID,'/')), '/T')-2) into t_port_group from dual;
            
        elsif substr(t_hf_port,0,3)  = 'ZTE' then
        select SUBSTR(NASPORTID, 1, INSTR(NASPORTID, '/') - 1) || ' ' || SUBSTR(NASPORTID, INSTR(NASPORTID, '/')+1,INSTR(substr(NASPORTID,instr(NASPORTID,'/')), '/Z')-2) into t_port_group from dual;
        
        else
        select SUBSTR(NASPORTID, 1, INSTR(NASPORTID, '/') - 1) || ' ' || SUBSTR(NASPORTID, INSTR(NASPORTID, '/')+1,INSTR(substr(NASPORTID,instr(NASPORTID,'/')), '/F')-2) into t_port_group from dual;
        ...
        select SUBSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, '#O')+1), 1, INSTR(SUBSTR(NASPORTID,INSTR(NASPORTID, '#O')+1), ':') - 1) into t_port_group from dual;
            ...
            --t_port_group := 'VDSL-AIS';
            end if;
        end if;
    
    elsif substr(NASPORTID,0,3)  = 'OX_' then 
    select SUBSTR(NASPORTID, 1, INSTR(NASPORTID, ' ') - 1)  || ' ' ||
    SUBSTR(SUBSTR(NASPORTID, INSTR(NASPORTID, ' ') +1,length(NASPORTID)) , 1, INSTR(SUBSTR(NASPORTID, INSTR(NASPORTID, ' ') +1,length(NASPORTID)) , ':') - 1) into t_port_group from dual;
    ...
    select substr(NASPORTID,0,instr(NASPORTID,'/ZTE')-4) into t_port_group from dual;
...
END FN_GET_NODE_SLOT_PORT_NUMBER;
